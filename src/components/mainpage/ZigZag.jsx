          ...
          <h2>PROCESS</h2>
            <div className="zigzag-item">
                <div className="content">
                    ...
                    <h4 className="right" style={{ marginRight: '5rem', paddingTop: "4rem", width: '347px' }}>
                        Beans are the seeds of the coffe cherry</h4>
                </div>
            ...
            <div className="zigzag-item">
                <div className="content" style={{ paddingLeft: '40rem' }}>
                    ...
                    <div className="text">
                        <h4 className='first' style={{ marginLeft: '4rem', width: '353px' }}>They are cleaned, triaged, and processed.</h4>
                        <img className="circle" src={process} alt="Event 2" />
